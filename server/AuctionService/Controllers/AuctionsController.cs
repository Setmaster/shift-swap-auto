...
public class AuctionsController: ControllerBase
{
    ...
    public async Task<ActionResult<List<AuctionDto>>> GetAllAuctions()
    {
        ...
        var auctions = await _context.Auctions
            .Include(x => x.Item) // This tells EF Core to include the related Item entity when querying the Auctions table, eager loading. Without this, the Item properties would not be loaded automatically (lazy loading) and would require a separate query to access 
